...
const { backendUrl,
        isLoggedin,
        userData,getUserData}=useContext(AppContent)
...
<button className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white font-semibold rounded-full'>Verify Email</button>
